...
Inst : WHILE Exp LBRACE List RBRACE                                        { While $2 $4 }
     | IF Exp LBRACE List RBRACE ELSE LBRACE List RBRACE                   { IfElse $2 $4 $8 }
     | IF Exp LBRACE List RBRACE                                           { If $2 $4 }
     | VAL ID COLON ID                                                     { case $2 of ID s1 -> case $4 of ID s2 -> DeclareType s1 s2 }
